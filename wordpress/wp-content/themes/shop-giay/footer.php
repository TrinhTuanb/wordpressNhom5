<div class="footer">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="copyright">
                                        <span>Copyright &copy; 2022 Group 5.</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="payment f-right">
                                        <a href="#">
                                            <img src="https://htmldemo.net/raavin/raavin/images/payment/1.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content product-details-large myTabContent">
                              <div class="tab-pane fade show active" id="single-slide1" role="tabpanel" aria-labelledby="single-slide-tab-1">
                                  ...
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/1.jpg" alt="">
                                  </div>
                              ...
                              <div class="tab-pane fade" id="single-slide2" role="tabpanel" aria-labelledby="single-slide-tab-2">
                                  <!--Single Product Image Start-->
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/2.jpg" alt="">
                                  </div>
                                  <!--Single Product Image End-->
                              </div>
                              <div class="tab-pane fade" id="single-slide3" role="tabpanel" aria-labelledby="single-slide-tab-3">
                                  <!--Single Product Image Start-->
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/3.jpg" alt="">
                                  </div>
                                  <!--Single Product Image End-->
                              </div>
                              <div class="tab-pane fade" id="single-slide4" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                  <!--Single Product Image Start-->
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/4.jpg" alt="">
                                  </div>
                                  <!--Single Product Image End-->
                              </div>
                              <div class="tab-pane fade" id="single-slide5" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                  <!--Single Product Image Start-->
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/5.jpg" alt="">
                                  </div>
                                  <!--Single Product Image End-->
                              </div>
                              <div class="tab-pane fade" id="single-slide6" role="tabpanel" aria-labelledby="single-slide-tab-4">
                                  <!--Single Product Image Start-->
                                  <div class="single-product-img img-full">
                                    <img src="https://htmldemo.net/raavin/raavin/images/single-product/large/6.jpg" alt="">
                                  </div>
                                  <!--Single Product Image End-->
                              </div>
                            </div>
                            ...
                            <div class="single-product-menu">
                                <div class="nav single-slide-menu owl-carousel" role="tablist">
                                    <div class="single-tab-menu img-full">
                                        <a class="active" data-bs-toggle="tab" id="single-slide-tab-1" href="#single-slide1"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/1.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-bs-toggle="tab" id="single-slide-tab-2" href="#single-slide2"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/2.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-bs-toggle="tab" id="single-slide-tab-3" href="#single-slide3"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/3.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-bs-toggle="tab" id="single-slide-tab-4" href="#single-slide4"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/4.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-bs-toggle="tab" id="single-slide-tab-5" href="#single-slide5"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/5.jpg" alt=""></a>
                                    </div>
                                    <div class="single-tab-menu img-full">
                                        <a data-bs-toggle="tab" id="single-slide-tab-6" href="#single-slide6"><img src="https://htmldemo.net/raavin/raavin/images/single-product/small/6.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                               ...
                               <!-- Begin Social Share Area -->
                                <div class="social-share mt-20">
                                    ...
                                    <ul class="socil-icon2">
                                         ...
                                         <li><a href="#" data-bs-toggle="tooltip" title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
        ...
        <script src="<?php bloginfo('template_directory') ?>/js/jquery-migrate-3.3.2.min.js"></script>
        <!-- Bootstrap v5.0.2 Fremwork js -->
        <script src="<?php bloginfo('template_directory') ?>/js/bootstrap.bundle.min.js"></script>
        <!-- Ajax Mail js -->
        <script src="<?php bloginfo('template_directory') ?>/js/ajax-mail.js"></script>
        <!-- Meanmenu js -->
        <script src="<?php bloginfo('template_directory') ?>/js/jquery.meanmenu.min.js"></script>
        <!-- Wow.min js -->
        ...
        <!-- Barrating -->
        <script src="<?php bloginfo('template_directory') ?>/js/jquery.barrating.min.js"></script>
        <!-- Jquery-ui -->
        ...
        <!-- ScrollUp js -->
        <script src="<?php bloginfo('template_directory') ?>/js/scrollUp.min.js"></script>
        <!-- Main/Activator js -->
