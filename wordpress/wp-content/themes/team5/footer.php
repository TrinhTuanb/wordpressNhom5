            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="box-footer info-contact">
                    ...
                    <div class="content-contact">
                            ...
                            <strong>Địa chỉ:</strong> 53 Võ Văn Ngân, Linh Chiểu, Thủ Đức
                        </p>
                        <p>
                            <strong>Email: </strong> 20211tt1477@mail.tdc.edu.vn
                        </p>
                        <p>
                            <strong>Điện thoại: </strong> 0365756xxx
                        </p>
